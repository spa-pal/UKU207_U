...
//o_12_s Надо доделать. Сейчас отображается только БДВ№1, а их стало 8.
...
/* //Заремированное можно удалить.
      	switch (env[1]) {
        	...
        	case '0':
          		switch (env[2]) {
		        	case '0':
		          		len = sprintf((char *)buf,(const char *)&env[4],snmp_enmv_data[0][0]);
		          		break;
		     		case '1':
		          		len = sprintf((char *)buf,(const char *)&env[4],snmp_enmv_data[1][0]);
		          		break;
		     		case '2':
		          		len = sprintf((char *)buf,(const char *)&env[4],snmp_enmv_data[2][0]);
		          		break;
		     		case '3':
		          		len = sprintf((char *)buf,(const char *)&env[4],snmp_enmv_data[3][0]);
		          		break;
		     		case '4':
		          		len = sprintf((char *)buf,(const char *)&env[4],snmp_enmv_data[4][0]);
		          		break;
		        	case '5':
		          		len = sprintf((char *)buf,(const char *)&env[4],snmp_enmv_data[5][0]);
		          		break;
		     		case '6':
		          		len = sprintf((char *)buf,(const char *)&env[4],snmp_enmv_data[6][0]);
		          		break;
		     		case '7':
		          		len = sprintf((char *)buf,(const char *)&env[4],snmp_enmv_data[7][0]);
		          		break;
		     		case '8':
		          		len = sprintf((char *)buf,(const char *)&env[4],snmp_enmv_data[8][0]);
		          		break;
		     		case '9':
		          		len = sprintf((char *)buf,(const char *)&env[4],snmp_enmv_data[9][0]);
		          		break;
				}
				break;
        	case '1':
          		switch (env[2]) {
		        	case '0':
		          		len = sprintf((char *)buf,(const char *)&env[4],snmp_enmv_data[10][0]);
		          		break;
		     		case '1':
		          		len = sprintf((char *)buf,(const char *)&env[4],snmp_enmv_data[11][0]);
		          		break;
		     		case '2':
		          		len = sprintf((char *)buf,(const char *)&env[4],snmp_enmv_data[12][0]);
		          		break;
		     		case '3':
		          		len = sprintf((char *)buf,(const char *)&env[4],snmp_enmv_data[13][0]);
		          		break;
		     		case '4':
		          		len = sprintf((char *)buf,(const char *)&env[4],snmp_enmv_data[14][0]);
		          		break;
		        	case '5':
		          		len = sprintf((char *)buf,(const char *)&env[4],snmp_enmv_data[15][0]);
		          		break;
		     		case '6':
		          		len = sprintf((char *)buf,(const char *)&env[4],snmp_enmv_data[16][0]);
		          		break;
		     		case '7':
		          		len = sprintf((char *)buf,(const char *)&env[4],snmp_enmv_data[17][0]);
		          		break;
		     		case '8':
		          		len = sprintf((char *)buf,(const char *)&env[4],snmp_enmv_data[18][0]);
		          		break;
		     		case '9':
		          		len = sprintf((char *)buf,(const char *)&env[4],snmp_enmv_data[19][0]);
		          		break;
				}
				break;
        	case '2':
          		switch (env[2]) {
		        	case '0':
		          		len = sprintf((char *)buf,(const char *)&env[4],snmp_enmv_data[20][0]);
		          		break;
		     		case '1':
		          		len = sprintf((char *)buf,(const char *)&env[4],snmp_enmv_data[21][0]);
		          		break;
		     		case '2':
		          		len = sprintf((char *)buf,(const char *)&env[4],snmp_enmv_data[22][0]);
		          		break;
		     		case '3':
		          		len = sprintf((char *)buf,(const char *)&env[4],snmp_enmv_data[23][0]);
		          		break;
		     		case '4':
		          		len = sprintf((char *)buf,(const char *)&env[4],snmp_enmv_data[24][0]);
		          		break;
		        	case '5':
		          		len = sprintf((char *)buf,(const char *)&env[4],snmp_enmv_data[25][0]);
		          		break;
		     		case '6':
		          		len = sprintf((char *)buf,(const char *)&env[4],snmp_enmv_data[26][0]);
		          		break;
		     		case '7':
		          		len = sprintf((char *)buf,(const char *)&env[4],snmp_enmv_data[27][0]);
		          		break;
		     		case '8':
		          		len = sprintf((char *)buf,(const char *)&env[4],snmp_enmv_data[28][0]);
		          		break;
		     		case '9':
		          		len = sprintf((char *)buf,(const char *)&env[4],snmp_enmv_data[29][0]);
		          		break;
				}
				break;
        	case '3':
          		switch (env[2]) {
		        	case '0':
		          		len = sprintf((char *)buf,(const char *)&env[4],snmp_enmv_data[30][0]);
		          		break;
		     		case '1':
		          		len = sprintf((char *)buf,(const char *)&env[4],snmp_enmv_data[31][0]);
		          		break;
		     		case '2':
		          		len = sprintf((char *)buf,(const char *)&env[4],snmp_enmv_data[32][0]);
		          		break;
		     		case '3':
		          		len = sprintf((char *)buf,(const char *)&env[4],snmp_enmv_data[33][0]);
		          		break;
		     		case '4':
		          		len = sprintf((char *)buf,(const char *)&env[4],snmp_enmv_data[34][0]);
		          		break;
		        	case '5':
		          		len = sprintf((char *)buf,(const char *)&env[4],snmp_enmv_data[35][0]);
		          		break;
		     		case '6':
		          		len = sprintf((char *)buf,(const char *)&env[4],snmp_enmv_data[36][0]);
		          		break;
		     		case '7':
		          		len = sprintf((char *)buf,(const char *)&env[4],snmp_enmv_data[37][0]);
		          		break;
		     		case '8':
		          		len = sprintf((char *)buf,(const char *)&env[4],snmp_enmv_data[38][0]);
		          		break;
		     		case '9':
		          		len = sprintf((char *)buf,(const char *)&env[4],snmp_enmv_data[39][0]);
		          		break;
				}
				break;
        	case '4':
          		switch (env[2]) {
		        	case '0':
		          		len = sprintf((char *)buf,(const char *)&env[4],snmp_enmv_data[40][0]);
		          		break;
		     		case '1':
		          		len = sprintf((char *)buf,(const char *)&env[4],snmp_enmv_data[41][0]);
		          		break;
		     		case '2':
		          		len = sprintf((char *)buf,(const char *)&env[4],snmp_enmv_data[42][0]);
		          		break;
		     		case '3':
		          		len = sprintf((char *)buf,(const char *)&env[4],snmp_enmv_data[43][0]);
		          		break;
		     		case '4':
		          		len = sprintf((char *)buf,(const char *)&env[4],snmp_enmv_data[44][0]);
		          		break;
		        	case '5':
		          		len = sprintf((char *)buf,(const char *)&env[4],snmp_enmv_data[45][0]);
		          		break;
		     		case '6':
		          		len = sprintf((char *)buf,(const char *)&env[4],snmp_enmv_data[46][0]);
		          		break;
		     		case '7':
		          		len = sprintf((char *)buf,(const char *)&env[4],snmp_enmv_data[47][0]);
		          		break;
		     		case '8':
		          		len = sprintf((char *)buf,(const char *)&env[4],snmp_enmv_data[48][0]);
		          		break;
		     		case '9':
		          		len = sprintf((char *)buf,(const char *)&env[4],snmp_enmv_data[49][0]);
		          		break;
				}
				break;
        	case '5':
          		switch (env[2]) {
		        	case '0':
		          		len = sprintf((char *)buf,(const char *)&env[4],snmp_enmv_data[50][0]);
		          		break;
		     		case '1':
		          		len = sprintf((char *)buf,(const char *)&env[4],snmp_enmv_data[51][0]);
		          		break;
		     		case '2':
		          		len = sprintf((char *)buf,(const char *)&env[4],snmp_enmv_data[52][0]);
		          		break;
		     		case '3':
		          		len = sprintf((char *)buf,(const char *)&env[4],snmp_enmv_data[53][0]);
		          		break;
		     		case '4':
		          		len = sprintf((char *)buf,(const char *)&env[4],snmp_enmv_data[54][0]);
		          		break;
		        	case '5':
		          		len = sprintf((char *)buf,(const char *)&env[4],snmp_enmv_data[55][0]);
		          		break;
		     		case '6':
		          		len = sprintf((char *)buf,(const char *)&env[4],snmp_enmv_data[56][0]);
		          		break;
		     		case '7':
		          		len = sprintf((char *)buf,(const char *)&env[4],snmp_enmv_data[57][0]);
		          		break;
		     		case '8':
		          		len = sprintf((char *)buf,(const char *)&env[4],snmp_enmv_data[58][0]);
		          		break;
		     		case '9':
		          		len = sprintf((char *)buf,(const char *)&env[4],snmp_enmv_data[59][0]);
		          		break;
				}
				break;
        	case '6':
          		switch (env[2]) {
		        	case '0':
		          		len = sprintf((char *)buf,(const char *)&env[4],snmp_enmv_data[60][0]);
		          		break;
		     		case '1':
		          		len = sprintf((char *)buf,(const char *)&env[4],snmp_enmv_data[61][0]);
		          		break;
		     		case '2':
		          		len = sprintf((char *)buf,(const char *)&env[4],snmp_enmv_data[62][0]);
		          		break;
		     		case '3':
		          		len = sprintf((char *)buf,(const char *)&env[4],snmp_enmv_data[63][0]);
		          		break;
				}
				break;
