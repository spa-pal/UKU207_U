...
extern unsigned short Iddt_porog_pred, Iddt_porog_error; //rki_1 
extern unsigned char n_error_ddt_uku, u_rki;  //rki_1
extern unsigned short Rddt[8][4]; //rki_1 
...
extern unsigned char ddt_error; // нет связи с дат тока	  //rki_1
extern unsigned short status_izm_r;	// аварии измерения изоляции
extern unsigned int sk_alarm, status_di1, status_di2; // авария СК 
