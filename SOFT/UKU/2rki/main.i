...
#line 251 "eeprom_map.h"



#line 262 "eeprom_map.h"



#line 319 "eeprom_map.h"

#line 360 "eeprom_map.h"
...
unsigned int sk1_24;
unsigned short Iddt_porog_pred, Iddt_porog_error; 
...
if((cnt_net_drv>=0)&&(cnt_net_drv<=11)) 
...
#line 16377 "main.c"
	...
	if(but==251)
		{
		a_ind . s_i++;
		if(a_ind . s_i==(5+NUMBAT+NUMIST+(num_rki!=0)+(num_net_in!=0)+(NUMEXT!=0)))
			{
			a_ind . i_s=a_ind . s_i+2;
			}
		if(a_ind . s_i==(6+NUMBAT+NUMIST+(num_rki!=0)+(num_net_in!=0)+(NUMEXT!=0)))
			{
			a_ind . s_i+=2;
			a_ind . i_s=a_ind . s_i+2;
			}
		else if(a_ind . s_i==(7+NUMBAT+NUMIST+(num_rki!=0)+(num_net_in!=0)+(NUMEXT!=0)))
			{
			a_ind . s_i++;
			a_ind . i_s=a_ind . s_i+2;
			}
		if(a_ind . s_i==(8+NUMBAT+NUMIST+(num_rki!=0)+(num_net_in!=0)+(NUMEXT!=0)))
			{
			a_ind . i_s=a_ind . s_i+2;
			}
		if(a_ind . s_i==(9+NUMBAT+NUMIST+(num_rki!=0)+(num_net_in!=0)+(NUMEXT!=0)))a_ind . s_i+=2;
		else if(a_ind . s_i==(10+NUMBAT+NUMIST+(num_rki!=0)+(num_net_in!=0)+(NUMEXT!=0)))a_ind . s_i++;
		gran_char(&a_ind . s_i,0,17+NUMIST+(NUMEXT!=0)+(num_rki!=0)+(num_net_in!=0));
		}
	else if(but==253)
		{
		a_ind . s_i--;
		...
		if(a_ind . s_i==(9+NUMBAT+NUMIST+(num_rki!=0)+(num_net_in!=0)+(NUMEXT!=0)))
			{
			a_ind . s_i--;
			a_ind . i_s=a_ind . s_i+2;
			}
		else if(a_ind . s_i==(10+NUMBAT+NUMIST+(num_rki!=0)+(num_net_in!=0)+(NUMEXT!=0)))
			{
			a_ind . s_i-=2;
			a_ind . i_s=a_ind . s_i+2;
			}
		...
		else if(a_ind . s_i==(4+NUMBAT+NUMIST+(num_rki!=0)+(num_net_in!=0)+(NUMEXT!=0)))
			{
		...
		else if(a_ind . s_i==(5+NUMBAT+NUMIST+(num_rki!=0)+(num_net_in!=0)+(NUMEXT!=0)))
			{
			if(but==254)
				{
				if(vz1_stat==vz1sOFF)
		...
		else if(a_ind . s_i==(8+NUMBAT+NUMIST+(num_rki!=0)+(num_net_in!=0)+(NUMEXT!=0)))
			{
			if(but==254)
				{
				if(vz2_stat==vz2sOFF)
		...
		else if(a_ind . s_i==(11+NUMBAT+NUMIST+(num_rki!=0)+(num_net_in!=0)+(NUMEXT!=0)))
			{
			tree_up(iSet_prl,0,0,0);
		     ret(50);
		     parol_init();
			}
		else if(a_ind . s_i==(12+NUMBAT+NUMIST+(num_rki!=0)+(num_net_in!=0)+(NUMEXT!=0)))
			{
			if(but==126)avar_uout_hndl(1);
			tree_up(iLog,0,0,0);
		     ret(1000);
			}
		else if(a_ind . s_i==(13+NUMBAT+NUMIST+(num_rki!=0)+(num_net_in!=0)+(NUMEXT!=0)))
			{
			a_ind . s_i=0;
			}
		...
		else if(a_ind . s_i==(14+NUMBAT+NUMIST+(num_rki!=0)+(num_net_in!=0)+(NUMEXT!=0)))
			{
			if(but==254)
		     	{
		     	tree_up(iPrltst,0,0,0);
		...
		else if(a_ind . s_i==(15+NUMBAT+NUMIST+(num_rki!=0)+(num_net_in!=0)+(NUMEXT!=0)))
			{
			if(but==254)
		     	{
		     	tree_up(iBps_list,0,0,0);
		...
		else if(a_ind . s_i==(16+NUMBAT+NUMIST+(num_rki!=0)+(num_net_in!=0)+(NUMEXT!=0)))
			{
			if(but==254)
		     	{
		...
		else if(a_ind . s_i==(17+NUMBAT+NUMIST+(num_rki!=0)+(num_net_in!=0)+(NUMEXT!=0)))
			{
			if(but==254)
		     	{
		     	tree_up(iSpecInf,0,0,0);
	...
	||(a_ind . i==iPrltst)||(a_ind . i==iPrlVZ1)||(a_ind . i==iPrlVZ2))
	{
	ret(50);
	if(but==239)
		{
...
#line 23658 "main.c"
	...
	if(but==251)
     ...
     else if((a_ind . s_i==36) || (a_ind . s_i==3))
		{
		if(but==254)
		     {
		     tree_down(0,0);
	...
	if(but==251)
		...
		if(a_ind . s_i==7)a_ind . i_s=8;
		if(a_ind . s_i==8)a_ind . s_i=9;
		if(a_ind . s_i==11)a_ind . i_s=10;
		if(a_ind . s_i==12)a_ind . s_i=13;
		if(a_ind . s_i==30)a_ind . i_s=32;
		if((a_ind . s_i==31)||(a_ind . s_i==32))a_ind . s_i=33;
		if(a_ind . s_i==33)a_ind . i_s=35;
		if((a_ind . s_i==34)||(a_ind . s_i==35))a_ind . s_i=36;
        if(a_ind . s_i==37)
        	{
            a_ind . i_s=36;
            }
		...
		if((a_ind . s_i==32)||(a_ind . s_i==31))
        	{
            a_ind . s_i=30;
		    }
        if((a_ind . s_i==35)||(a_ind . s_i==34))
        	{
            a_ind . s_i=33;
		    }
	...
	else if((a_ind . s_i==63) || (a_ind . s_i==5))
		{
		if(but==254)
		     {
		     tree_down(0,0);
	...
	if(but==251)
		{
		a_ind . s_i++;
		gran_char(&a_ind . s_i,0,4+(NUMIST!=0)+(NUMDT!=0)+(num_rki!=0)+(num_net_in!=0)); 
		}
	else if(but==253)
		{
		a_ind . s_i--;
		...
		else if(a_ind . s_i==(4+(NUMIST!=0)+(NUMDT!=0)+(num_rki!=0)+(num_net_in!=0)))
			{
			if((but==239)||(but==111))
				{
				if(RS485_QWARZ_DIGIT==10)RS485_QWARZ_DIGIT=30;
...
#line 36377 "main.c"
 ...
 if(a_ind . s_i==0)
	    ...
	    {
		if(but==239)IMAX_VZ++;
	    else if(but==111)IMAX_VZ+=10;
	    else if(but==247)IMAX_VZ--;
	    else if(but==119)IMAX_VZ-=10;
	...
	if(but==251)
	    ...
	    {
		if(but==239)UZ_IMAX++;
	    else if(but==111)UZ_IMAX+=2;
	    else if(but==247)UZ_IMAX--;
	    else if(but==119)UZ_IMAX-=2;
