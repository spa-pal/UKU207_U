#line 1 "ips_sgep_gazprom.c"
#line 1 "ips_sgep_gazprom.h"

void ipsSgepGazpromEeSets(void);
#line 2 "ips_sgep_gazprom.c"
#line 1 "25lc640.h"
...
#line 249 "eeprom_map.h"



#line 306 "eeprom_map.h"

#line 347 "eeprom_map.h"
...
if(lc640_read_int(0x10+100+244)!=hvsOFF)lc640_write(0x10+100+244,hvsOFF);
if(lc640_read_int(0x10+100+78)!=0)lc640_write_int(0x10+100+78,0);
if(lc640_read_int(0x10+100+34)!=3)lc640_write_int(0x10+100+34,0);
}
