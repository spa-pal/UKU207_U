		...
		if(modbus_tcp_func==4)		
			...
			if(modbus_tcp_rx_arg0==15)		
				...
				if(modbus_tcp_rx_arg0==32)		
					{
					lc640_write_int(0x10+100+84,UB20-modbus_tcp_rx_arg1);
		     		}
				if(modbus_tcp_rx_arg0==33)		
					{
					lc640_write_int(0x10+100+6,modbus_tcp_rx_arg1);
		     		}
				if(modbus_tcp_rx_arg0==34)		
					{
					lc640_write_int(0x10+100+8,modbus_tcp_rx_arg1);
		     		}
				...
				if(modbus_tcp_rx_arg0==42)		
					{
					lc640_write_int(0x10+100+106,modbus_tcp_rx_arg1);
		     		}
			...
			if(modbus_tcp_rx_arg0==55)		
				{
				lc640_write_int(4470,modbus_tcp_rx_arg1);
	     		}
			if(modbus_tcp_rx_arg0==56)		
				{
				if(modbus_tcp_rx_arg1<=3) lc640_write_int(0x10+350+26,modbus_tcp_rx_arg1);
	     		}						
			if(modbus_tcp_rx_arg0==57)		
				{
				signed short www=(signed short)modbus_tcp_rx_arg1;
				if(www>=-12 && www<=13) lc640_write_int(0x10+350+28,modbus_tcp_rx_arg1);
	     		}						
			if(modbus_tcp_rx_arg0==58)		
				{
				if(modbus_tcp_rx_arg1<=255) lc640_write_int(4474,modbus_tcp_rx_arg1);
	     		}						
			if(modbus_tcp_rx_arg0==59)		
				{
				if(modbus_tcp_rx_arg1<=255) lc640_write_int(4476,modbus_tcp_rx_arg1);
	     		}						
			if(modbus_tcp_rx_arg0==60)		
				{
				if(modbus_tcp_rx_arg1<=255) lc640_write_int(4478,modbus_tcp_rx_arg1);
	     		}						
			if(modbus_tcp_rx_arg0==61)		
				{
				if(modbus_tcp_rx_arg1<=255) lc640_write_int(4480,modbus_tcp_rx_arg1);
	     		}
			if(modbus_tcp_rx_arg0==62)		
				{

				if(modbus_tcp_rx_arg1<=2) lc640_write_int(0x10+350+72,modbus_tcp_rx_arg1);
			...
			if(modbus_tcp_rx_arg0==63)		
				{
				if(modbus_tcp_rx_arg1<=3) lc640_write_int(0x10+500+90,modbus_tcp_rx_arg1);
	     		}	
			if(modbus_tcp_rx_arg0==64)		
				{
				if(modbus_tcp_rx_arg1==0 || modbus_tcp_rx_arg1==2 || modbus_tcp_rx_arg1==4) lc640_write_int(0x10+500+100,modbus_tcp_rx_arg1);
	     		}
			if(modbus_tcp_rx_arg0==65)		
				{
				if(modbus_tcp_rx_arg1<=4) lc640_write_int(0x10+500+88,modbus_tcp_rx_arg1);
	     		}
			if(modbus_tcp_rx_arg0==66)		
				{
				if(modbus_tcp_rx_arg1==0 || modbus_tcp_rx_arg1==1) lc640_write_int(0x10+54,modbus_tcp_rx_arg1);
	     		}
			if(modbus_tcp_rx_arg0==67)		
				{
				if(modbus_tcp_rx_arg1==0 || modbus_tcp_rx_arg1==1) lc640_write_int(0x10+56,modbus_tcp_rx_arg1);
	     		}
			if(modbus_tcp_rx_arg0==68)		
				{
				if(modbus_tcp_rx_arg1==0 || modbus_tcp_rx_arg1==1) lc640_write_int(0x10+500+104,modbus_tcp_rx_arg1);
	     		}
			if(modbus_tcp_rx_arg0==69)		
				{
				if(modbus_tcp_rx_arg1>0 && modbus_tcp_rx_arg1<9) lc640_write_int(4352,modbus_tcp_rx_arg1); 
	     		}
			if(modbus_tcp_rx_arg0==70)		
				{
				if(modbus_tcp_rx_arg1>=1 && modbus_tcp_rx_arg1<=200) lc640_write_int(0x10+350+92,modbus_tcp_rx_arg1);
	     		}
			if(modbus_tcp_rx_arg0==71)		
				{
				if(modbus_tcp_rx_arg1>=10 && modbus_tcp_rx_arg1<=25000) lc640_write_int(0x10+350+70,modbus_tcp_rx_arg1);
	     		}
			if(modbus_tcp_rx_arg0==72)		
				{
				if(modbus_tcp_rx_arg1>=10 && modbus_tcp_rx_arg1<=21000) lc640_write_int(0x10+350+68,modbus_tcp_rx_arg1);
	     		}
			if(modbus_tcp_rx_arg0==73)		
				{
				if(modbus_tcp_rx_arg1>=10 && modbus_tcp_rx_arg1<=20000) lc640_write_int(0x10+350+66,modbus_tcp_rx_arg1);
	     		}
			if(modbus_tcp_rx_arg0==74)		
				{
				if(modbus_tcp_rx_arg1>=10 && modbus_tcp_rx_arg1<=18000) lc640_write_int(0x10+350+64,modbus_tcp_rx_arg1);
	     		}
			if(modbus_tcp_rx_arg0==75)		
				{
				if(modbus_tcp_rx_arg1>=10 && modbus_tcp_rx_arg1<=16000) lc640_write_int(0x10+350+62,modbus_tcp_rx_arg1);
	     		}
			if(modbus_tcp_rx_arg0==76)		
				{
				if(modbus_tcp_rx_arg1>=10 && modbus_tcp_rx_arg1<=13000) lc640_write_int(0x10+350+60,modbus_tcp_rx_arg1);
	     		}
			if(modbus_tcp_rx_arg0==77)		
				{
				if(modbus_tcp_rx_arg1>=10 && modbus_tcp_rx_arg1<=8000) lc640_write_int(0x10+350+58,modbus_tcp_rx_arg1);
	     		}
			if(modbus_tcp_rx_arg0==78)		
				{
				if(modbus_tcp_rx_arg1>=10 && modbus_tcp_rx_arg1<=10000) lc640_write_int(0x10+350+86,modbus_tcp_rx_arg1);
	     		}
			if(modbus_tcp_rx_arg0==79)		
				{
				if(modbus_tcp_rx_arg1>=10 && modbus_tcp_rx_arg1<=10000) lc640_write_int(0x10+350+84,modbus_tcp_rx_arg1);
	     		}
			if(modbus_tcp_rx_arg0==80)		
				{
				if(modbus_tcp_rx_arg1>=10 && modbus_tcp_rx_arg1<=10000) lc640_write_int(0x10+350+82,modbus_tcp_rx_arg1);
	     		}
			if(modbus_tcp_rx_arg0==81)		
				{
				if(modbus_tcp_rx_arg1>=10 && modbus_tcp_rx_arg1<=10000) lc640_write_int(0x10+350+80,modbus_tcp_rx_arg1);
	     		}
			if(modbus_tcp_rx_arg0==82)		
				{
				if(modbus_tcp_rx_arg1>=10 && modbus_tcp_rx_arg1<=10000) lc640_write_int(0x10+350+78,modbus_tcp_rx_arg1);
	     		}
			if(modbus_tcp_rx_arg0==83)		
				{
				if(modbus_tcp_rx_arg1>=10 && modbus_tcp_rx_arg1<=10000) lc640_write_int(0x10+350+76,modbus_tcp_rx_arg1);
	     		}
			if(modbus_tcp_rx_arg0==84)		
				{
				if(modbus_tcp_rx_arg1>=10 && modbus_tcp_rx_arg1<=10000) lc640_write_int(0x10+350+74,modbus_tcp_rx_arg1);
	     		}
			if(modbus_tcp_rx_arg0==85)		
				{
				if(modbus_tcp_rx_arg1>=10 && modbus_tcp_rx_arg1<=100) lc640_write_int(0x10+350+94,modbus_tcp_rx_arg1);
	     		}		
			if(modbus_tcp_rx_arg0==86)		
				{
				if(modbus_tcp_rx_arg1>=15 && modbus_tcp_rx_arg1<=250) lc640_write_int(0x10+100+240,modbus_tcp_rx_arg1);
	     		}			
			if(modbus_tcp_rx_arg0==87)		
				{
				if(modbus_tcp_rx_arg1>=10 && modbus_tcp_rx_arg1<=2000) lc640_write_int(0x10+350+54,modbus_tcp_rx_arg1);
	     		}  
			if(modbus_tcp_rx_arg0==88)		
				{
				if(modbus_tcp_rx_arg1<=72) lc640_write_int(0x10+100+76,modbus_tcp_rx_arg1);
	     		}
			if(modbus_tcp_rx_arg0==89)		
				{
				if(modbus_tcp_rx_arg1==0 || modbus_tcp_rx_arg1==1) lc640_write_int(0x10+350+98,modbus_tcp_rx_arg1);
	     		} 
			if(modbus_tcp_rx_arg0==90)		
				{
				if(modbus_tcp_rx_arg1==0 || modbus_tcp_rx_arg1==1) lc640_write_int(0x10+100+168,modbus_tcp_rx_arg1);
	     		}
			if(modbus_tcp_rx_arg0==91)		
				{
				if(modbus_tcp_rx_arg1>0 && modbus_tcp_rx_arg1<=100) lc640_write_int(0x10+100+170,modbus_tcp_rx_arg1);
	     		}
			if(modbus_tcp_rx_arg0==92)		
				{
				if(modbus_tcp_rx_arg1==0 || modbus_tcp_rx_arg1==2) lc640_write_int(0x10+100+172,modbus_tcp_rx_arg1);
	     		}
			if(modbus_tcp_rx_arg0==93)		
				{
				if(modbus_tcp_rx_arg1==0 || modbus_tcp_rx_arg1==1) lc640_write_int(0x10+100+174,modbus_tcp_rx_arg1);
	     		}
			if(modbus_tcp_rx_arg0==94)		
				{								
				if(modbus_tcp_rx_arg1==0 || modbus_tcp_rx_arg1==1) lc640_write_int(0x10+350+96,modbus_tcp_rx_arg1);
	     		}
			if(modbus_tcp_rx_arg0==95)		
				{								
				if(modbus_tcp_rx_arg1>=UB20 && modbus_tcp_rx_arg1<=2600) lc640_write_int(0x10+350+30,modbus_tcp_rx_arg1);
	     		}
			if(modbus_tcp_rx_arg0==96)		
				{
				if(modbus_tcp_rx_arg1>=10 && modbus_tcp_rx_arg1<=10000) lc640_write_int(0x10+350+32,modbus_tcp_rx_arg1);
	     		}
			if(modbus_tcp_rx_arg0==97)		
				{
				if(modbus_tcp_rx_arg1>=1 && modbus_tcp_rx_arg1<=72) lc640_write_int(0x10+350+34,modbus_tcp_rx_arg1);
	     		}					  
			if(modbus_tcp_rx_arg0==98)		
				{
				if(modbus_tcp_rx_arg1>=UB20 && modbus_tcp_rx_arg1<=3000) lc640_write_int(0x10+350+40,modbus_tcp_rx_arg1);
	     		}
			if(modbus_tcp_rx_arg0==99)		
				{
				if(modbus_tcp_rx_arg1>=10 && modbus_tcp_rx_arg1<=1000) lc640_write_int(0x10+350+42,modbus_tcp_rx_arg1);
	     		}
			
			if(modbus_tcp_rx_arg0==102)		
				{
				if(modbus_tcp_rx_arg1>=1 && modbus_tcp_rx_arg1<=10) lc640_write_int(0x10+350+44,modbus_tcp_rx_arg1);
	     		}
			if(modbus_tcp_rx_arg0==103)		
				{
				if(modbus_tcp_rx_arg1>=10 && modbus_tcp_rx_arg1<=1000) lc640_write_int(0x10+350+46,modbus_tcp_rx_arg1);
	     		}
			if(modbus_tcp_rx_arg0==104)		
				{
				if(modbus_tcp_rx_arg1>=UB20 && modbus_tcp_rx_arg1<=3000) lc640_write_int(0x10+350+48,modbus_tcp_rx_arg1);
	     		}
			if(modbus_tcp_rx_arg0==105)		
				{
				if(modbus_tcp_rx_arg1>=10 && modbus_tcp_rx_arg1<=1000) lc640_write_int(0x10+350+50,modbus_tcp_rx_arg1);
	     		}
			if(modbus_tcp_rx_arg0==106)		
				{
				if(modbus_tcp_rx_arg1>=1 && modbus_tcp_rx_arg1<=10) lc640_write_int(0x10+350+52,modbus_tcp_rx_arg1);
	     		}	 
			if(modbus_tcp_rx_arg0==107)		
				{
				if(modbus_tcp_rx_arg1==0 || modbus_tcp_rx_arg1==1) lc640_write_int(0x10+100+12,modbus_tcp_rx_arg1);
	     		}				
		   	if(modbus_tcp_rx_arg0==108)		
				{
				if(modbus_tcp_rx_arg1==0 || modbus_tcp_rx_arg1==1) lc640_write_int(0x10+100+44,modbus_tcp_rx_arg1);
	     		}
		  	if(modbus_tcp_rx_arg0==109)		
				{
				if(modbus_tcp_rx_arg1==0 || modbus_tcp_rx_arg1==1) lc640_write_int(0x10+100+46,modbus_tcp_rx_arg1);
	     		}		   
		 	if(modbus_tcp_rx_arg0==110)		
				{
				if(modbus_tcp_rx_arg1>=1 && modbus_tcp_rx_arg1<=24) lc640_write_int(0x10+100+48,modbus_tcp_rx_arg1);
	     		}  
			if(modbus_tcp_rx_arg0==111)		
				{
				if(modbus_tcp_rx_arg1==0)	   lc640_write_int(0x10+500+48,0xFFFF);
				else if(modbus_tcp_rx_arg1==1) lc640_write_int(0x10+500+48,0);
	     		} 	   
			if(modbus_tcp_rx_arg0==112)		
				{
				if(modbus_tcp_rx_arg1==0)	   lc640_write_int(0x10+500+52,0xFFFF);
				else if(modbus_tcp_rx_arg1==1) lc640_write_int(0x10+500+52,0);
	     		}
			if(modbus_tcp_rx_arg0==113)		
				{
				if(modbus_tcp_rx_arg1==0)	   lc640_write_int(0x10+500+54,0xFFFF);
				else if(modbus_tcp_rx_arg1==1) lc640_write_int(0x10+500+54,0);
	     		}
			if(modbus_tcp_rx_arg0==114)		
				{
				if(modbus_tcp_rx_arg1==0)	   lc640_write_int(0x10+500+58,0xFFFF);
				else if(modbus_tcp_rx_arg1==1) lc640_write_int(0x10+500+58,0);
	     		} 	   
			if(modbus_tcp_rx_arg0==115)		
				{
				if(modbus_tcp_rx_arg1==0)	   lc640_write_int(0x10+500+62,0xFFFF);
				else if(modbus_tcp_rx_arg1==1) lc640_write_int(0x10+500+62,0);
	     		}
			if(modbus_tcp_rx_arg0==116)		
				{
				if(modbus_tcp_rx_arg1==0)	   lc640_write_int(0x10+500+64,0xFFFF);
				else if(modbus_tcp_rx_arg1==1) lc640_write_int(0x10+500+64,0);
	     		}
			if(modbus_tcp_rx_arg0==117)		
				{
				if(modbus_tcp_rx_arg1==0)	   lc640_write_int(0x10+500+68,0xFFFF);
				else if(modbus_tcp_rx_arg1==1) lc640_write_int(0x10+500+68,0);
	     		} 	   
			if(modbus_tcp_rx_arg0==118)		
				{
				if(modbus_tcp_rx_arg1==0)	   lc640_write_int(0x10+500+72,0xFFFF);
				else if(modbus_tcp_rx_arg1==1) lc640_write_int(0x10+500+72,0);
	     		}
			if(modbus_tcp_rx_arg0==119)		
				{
				if(modbus_tcp_rx_arg1==0)	   lc640_write_int(0x10+500+74,0xFFFF);
				else if(modbus_tcp_rx_arg1==1) lc640_write_int(0x10+500+74,0);
	     		}
			if(modbus_tcp_rx_arg0==120)		
				{
				if(modbus_tcp_rx_arg1==0)	   lc640_write_int(0x10+500+78,0xFFFF);
				else if(modbus_tcp_rx_arg1==1) lc640_write_int(0x10+500+78,0);
	     		} 	   
			if(modbus_tcp_rx_arg0==121)		
				{
				if(modbus_tcp_rx_arg1==0)	   lc640_write_int(0x10+500+82,0xFFFF);
				else if(modbus_tcp_rx_arg1==1) lc640_write_int(0x10+500+82,0);
	     		}
			if(modbus_tcp_rx_arg0==122)		
				{
				if(modbus_tcp_rx_arg1==0)	   lc640_write_int(0x10+500+84,0xFFFF);
				else if(modbus_tcp_rx_arg1==1) lc640_write_int(0x10+500+84,0);
	     		}		  
		   	if(modbus_tcp_rx_arg0==123)		
				{
				if(modbus_tcp_rx_arg1==0 || modbus_tcp_rx_arg1==1) lc640_write_int(0x10+100+126,modbus_tcp_rx_arg1);
	     		}
			if(modbus_tcp_rx_arg0==124)		
				{
				if(modbus_tcp_rx_arg1<=500) lc640_write_int(0x10+100+178,modbus_tcp_rx_arg1);
	     		}
			if(modbus_tcp_rx_arg0==125)		
				{
				if(modbus_tcp_rx_arg1==0 || modbus_tcp_rx_arg1==1) lc640_write_int(0x10+100+188,modbus_tcp_rx_arg1);
	     		}
			if(modbus_tcp_rx_arg0==126)		
				{
				if(modbus_tcp_rx_arg1<=2) lc640_write_int(0x10+100+190,modbus_tcp_rx_arg1);
	     		}
			if(modbus_tcp_rx_arg0==127)		
				{
				if(modbus_tcp_rx_arg1==0 || modbus_tcp_rx_arg1==1) lc640_write_int(0x10+100+192,modbus_tcp_rx_arg1);
	     		} 
		   	if(modbus_tcp_rx_arg0==128)		
				{
				if(modbus_tcp_rx_arg1>0 && modbus_tcp_rx_arg1<=100) lc640_write_int(0x10+500+200+72,modbus_tcp_rx_arg1);
	     		}
			if(modbus_tcp_rx_arg0==129)		
				...
				|| modbus_tcp_rx_arg1==3840 || modbus_tcp_rx_arg1==5760 || modbus_tcp_rx_arg1==11520){ 
					lc640_write_int(0x10+500+200+74,modbus_tcp_rx_arg1);
					MODBUS_BAUDRATE=modbus_tcp_rx_arg1;
					}
	     		} 	
			if(modbus_tcp_rx_arg0==130)		
				{
				if(modbus_tcp_rx_arg1==0 || modbus_tcp_rx_arg1==1) lc640_write_int(0x10+500+200,modbus_tcp_rx_arg1);
	     		}	 
			if(modbus_tcp_rx_arg0==131)		
				{
				if(modbus_tcp_rx_arg1==0 || modbus_tcp_rx_arg1==1) lc640_write_int(0x10+500+200+2,modbus_tcp_rx_arg1);
	     		}
			if(modbus_tcp_rx_arg0==132)  
				{
				if(modbus_tcp_rx_arg1<=255) lc640_write_int(0x10+500+200+4,modbus_tcp_rx_arg1);
	     		}
			if(modbus_tcp_rx_arg0==133)		
				{
				if(modbus_tcp_rx_arg1<=255) lc640_write_int(0x10+500+200+6,modbus_tcp_rx_arg1);
	     		}
			if(modbus_tcp_rx_arg0==134)		
				{
				if(modbus_tcp_rx_arg1<=255) lc640_write_int(0x10+500+200+8,modbus_tcp_rx_arg1);
	     		}
			if(modbus_tcp_rx_arg0==135)		
				{
				if(modbus_tcp_rx_arg1<=255) lc640_write_int(0x10+500+200+10,modbus_tcp_rx_arg1);
	     		}
			if(modbus_tcp_rx_arg0==136)	
				{
				if(modbus_tcp_rx_arg1<=255) lc640_write_int(0x10+500+200+12,modbus_tcp_rx_arg1);
	     		}
			if(modbus_tcp_rx_arg0==137)		
				{
				if(modbus_tcp_rx_arg1<=255) lc640_write_int(0x10+500+200+14,modbus_tcp_rx_arg1);
	     		}
			if(modbus_tcp_rx_arg0==138)		
				{
				if(modbus_tcp_rx_arg1<=255) lc640_write_int(0x10+500+200+16,modbus_tcp_rx_arg1);
	     		}
			if(modbus_tcp_rx_arg0==139)		
				{
				if(modbus_tcp_rx_arg1<=255) lc640_write_int(0x10+500+200+18,modbus_tcp_rx_arg1);
	     		}
			if(modbus_tcp_rx_arg0==140)	
				{
				if(modbus_tcp_rx_arg1<=255) lc640_write_int(0x10+500+200+64,modbus_tcp_rx_arg1);
	     		}
			if(modbus_tcp_rx_arg0==141)		
				{
				if(modbus_tcp_rx_arg1<=255) lc640_write_int(0x10+500+200+66,modbus_tcp_rx_arg1);
	     		}
			if(modbus_tcp_rx_arg0==142)		
				{
				if(modbus_tcp_rx_arg1<=255) lc640_write_int(0x10+500+200+68,modbus_tcp_rx_arg1);
	     		}
			if(modbus_tcp_rx_arg0==143)		
				{
				if(modbus_tcp_rx_arg1<=255) lc640_write_int(0x10+500+200+70,modbus_tcp_rx_arg1);
	     		}	 
			if(modbus_tcp_rx_arg0==144)		
				{
				lc640_write_int(0x10+500+200+60,modbus_tcp_rx_arg1);
	     		}
			if(modbus_tcp_rx_arg0==145)		
				{
				lc640_write_int(0x10+500+200+62,modbus_tcp_rx_arg1);
	     		}
			if(modbus_tcp_rx_arg0==146)		
				{
				if(modbus_tcp_rx_arg1<=255) lc640_write_int(0x10+500+200+270,modbus_tcp_rx_arg1);
	     		}
			if(modbus_tcp_rx_arg0==147)		
				{
				if(modbus_tcp_rx_arg1<=255) lc640_write_int(0x10+500+200+270+2,modbus_tcp_rx_arg1);
	     		}
			if(modbus_tcp_rx_arg0==148)		
				{
				if(modbus_tcp_rx_arg1<=255) lc640_write_int(0x10+500+200+270+4,modbus_tcp_rx_arg1);
	     		}
			if(modbus_tcp_rx_arg0==149)		
				{
				if(modbus_tcp_rx_arg1<=255) lc640_write_int(0x10+500+200+270+6,modbus_tcp_rx_arg1);
	     		}
			if(modbus_tcp_rx_arg0==150)		
				{
				if(modbus_tcp_rx_arg1<=255) lc640_write_int(0x10+500+200+270+8,modbus_tcp_rx_arg1);
	     		}
			if(modbus_tcp_rx_arg0==151)		
				{
				if(modbus_tcp_rx_arg1<=255) lc640_write_int(0x10+500+200+270+10,modbus_tcp_rx_arg1);
	     		}
			if(modbus_tcp_rx_arg0==152)		
				{
				if(modbus_tcp_rx_arg1<=255) lc640_write_int(0x10+500+200+270+12,modbus_tcp_rx_arg1);
	     		}
			if(modbus_tcp_rx_arg0==153)		
				{
				if(modbus_tcp_rx_arg1<=255) lc640_write_int(0x10+500+200+270+14,modbus_tcp_rx_arg1);
	     		}
			if(modbus_tcp_rx_arg0==154)  
				{
				if(modbus_tcp_rx_arg1<=255) lc640_write_int(0x10+500+200+20,modbus_tcp_rx_arg1);
	     		}
			if(modbus_tcp_rx_arg0==155)		
				{
				if(modbus_tcp_rx_arg1<=255) lc640_write_int(0x10+500+200+22,modbus_tcp_rx_arg1);
	     		}
			if(modbus_tcp_rx_arg0==156)		
				{
				if(modbus_tcp_rx_arg1<=255) lc640_write_int(0x10+500+200+24,modbus_tcp_rx_arg1);
	     		}
			if(modbus_tcp_rx_arg0==157)		
				{
				if(modbus_tcp_rx_arg1<=255) lc640_write_int(0x10+500+200+26,modbus_tcp_rx_arg1);
	     		}
			if(modbus_tcp_rx_arg0==158)  
				{
				if(modbus_tcp_rx_arg1<=255) lc640_write_int(0x10+500+200+28,modbus_tcp_rx_arg1);
	     		}
			if(modbus_tcp_rx_arg0==159)		
				{
				if(modbus_tcp_rx_arg1<=255) lc640_write_int(0x10+500+200+30,modbus_tcp_rx_arg1);
	     		}
			if(modbus_tcp_rx_arg0==160)		
				{
				if(modbus_tcp_rx_arg1<=255) lc640_write_int(0x10+500+200+32,modbus_tcp_rx_arg1);
	     		}
			if(modbus_tcp_rx_arg0==161)		
				{
				if(modbus_tcp_rx_arg1<=255) lc640_write_int(0x10+500+200+34,modbus_tcp_rx_arg1);
	     		}
			if(modbus_tcp_rx_arg0==162)  
				{
				if(modbus_tcp_rx_arg1<=255) lc640_write_int(0x10+500+200+36,modbus_tcp_rx_arg1);
	     		}
			if(modbus_tcp_rx_arg0==163)		
				{
				if(modbus_tcp_rx_arg1<=255) lc640_write_int(0x10+500+200+38,modbus_tcp_rx_arg1);
	     		}
			if(modbus_tcp_rx_arg0==164)		
				{
				if(modbus_tcp_rx_arg1<=255) lc640_write_int(0x10+500+200+40,modbus_tcp_rx_arg1);
	     		}
			if(modbus_tcp_rx_arg0==165)		
				{
				if(modbus_tcp_rx_arg1<=255) lc640_write_int(0x10+500+200+42,modbus_tcp_rx_arg1);
	     		}
			if(modbus_tcp_rx_arg0==166)  
				{
				if(modbus_tcp_rx_arg1<=255) lc640_write_int(0x10+500+200+44,modbus_tcp_rx_arg1);
	     		}
			if(modbus_tcp_rx_arg0==167)		
				{
				if(modbus_tcp_rx_arg1<=255) lc640_write_int(0x10+500+200+46,modbus_tcp_rx_arg1);
	     		}
			if(modbus_tcp_rx_arg0==168)		
				{
				if(modbus_tcp_rx_arg1<=255) lc640_write_int(0x10+500+200+48,modbus_tcp_rx_arg1);
	     		}
			if(modbus_tcp_rx_arg0==169)		
				{
				if(modbus_tcp_rx_arg1<=255) lc640_write_int(0x10+500+200+50,modbus_tcp_rx_arg1);
	     		}
			if(modbus_tcp_rx_arg0==170)  
				{
				if(modbus_tcp_rx_arg1<=255) lc640_write_int(0x10+500+200+52,modbus_tcp_rx_arg1);
	     		}
			if(modbus_tcp_rx_arg0==171)		
				{
				if(modbus_tcp_rx_arg1<=255) lc640_write_int(0x10+500+200+54,modbus_tcp_rx_arg1);
	     		}
			if(modbus_tcp_rx_arg0==172)		
				{
				if(modbus_tcp_rx_arg1<=255) lc640_write_int(0x10+500+200+56,modbus_tcp_rx_arg1);
	     		}
			if(modbus_tcp_rx_arg0==173)		
				{
				if(modbus_tcp_rx_arg1<=255) lc640_write_int(0x10+500+200+58,modbus_tcp_rx_arg1);
	     		}
			if(modbus_tcp_rx_arg0==174)		
				{
				if(modbus_tcp_rx_arg1<=255) lc640_write_int(4360,modbus_tcp_rx_arg1);
	     		}
			if(modbus_tcp_rx_arg0==175)		
				{
				if(modbus_tcp_rx_arg1<=255) lc640_write_int(4360+2,modbus_tcp_rx_arg1);
	     		}
			if(modbus_tcp_rx_arg0==176)		
				{
				if(modbus_tcp_rx_arg1<=255) lc640_write_int(4360+4,modbus_tcp_rx_arg1);
	     		}
			if(modbus_tcp_rx_arg0==177 && modbus_tcp_rx_arg1>0) bRESET_INT_WDT=1;
			if(modbus_tcp_rx_arg0==178)		
				{
				modbus_tcp_rx_arg1/=10;
				if(modbus_tcp_rx_arg1<=6000) lc640_write_int(0x10+350+2,modbus_tcp_rx_arg1);
	     		} 
		   	if(modbus_tcp_rx_arg0==179)		
				{
				if(modbus_tcp_rx_arg1<=2) lc640_write_int(0x10+350+6,modbus_tcp_rx_arg1);
	     		}
			if(modbus_tcp_rx_arg0==180)		
				{
				if(modbus_tcp_rx_arg1<=2) lc640_write_int(0x10+350+4,modbus_tcp_rx_arg1);
	     		}
			if(modbus_tcp_rx_arg0==181)  
				{
				if(modbus_tcp_rx_arg1<=255) lc640_write_int(0x10+350+10,modbus_tcp_rx_arg1);
	     		}
			if(modbus_tcp_rx_arg0==182)		
				{
				if(modbus_tcp_rx_arg1<=255) lc640_write_int(0x10+350+12,modbus_tcp_rx_arg1);
	     		}
			if(modbus_tcp_rx_arg0==183)		
				{
				if(modbus_tcp_rx_arg1<=255) lc640_write_int(0x10+350+14,modbus_tcp_rx_arg1);
	     		}
			if(modbus_tcp_rx_arg0==184)		
				{
				if(modbus_tcp_rx_arg1<=255) lc640_write_int(0x10+350+16,modbus_tcp_rx_arg1);
	     		}
			if(modbus_tcp_rx_arg0==185)		
				{
				if(modbus_tcp_rx_arg1>0 && modbus_tcp_rx_arg1<=254) lc640_write_int(0x10+350+18,modbus_tcp_rx_arg1);
	     		}
			if(modbus_tcp_rx_arg0==186)		
				{
				if(modbus_tcp_rx_arg1>0 && modbus_tcp_rx_arg1<=254) lc640_write_int(0x10+350+8,modbus_tcp_rx_arg1);
	     		}
			if(modbus_tcp_rx_arg0==187)		
				{
				if(modbus_tcp_rx_arg1>=10 && modbus_tcp_rx_arg1<=100) lc640_write_int(0x10+350+20,modbus_tcp_rx_arg1);
	     		}
			if(modbus_tcp_rx_arg0==188)		
				{
				if(modbus_tcp_rx_arg1>=1 && modbus_tcp_rx_arg1<=3) lc640_write_int(0x10+350+22,modbus_tcp_rx_arg1);
	     		}
			if(modbus_tcp_rx_arg0==189)		
				{
				if(modbus_tcp_rx_arg1>=1 && modbus_tcp_rx_arg1<=5) lc640_write_int(0x10+350+24,modbus_tcp_rx_arg1);
	     		}
			if(modbus_tcp_rx_arg0==190)		
				{
				if(modbus_tcp_rx_arg1==0 || modbus_tcp_rx_arg1==1) lc640_write_int(0x10+350+56,modbus_tcp_rx_arg1);
	     		}
			if(modbus_tcp_rx_arg0==191)		
				{
				if(modbus_tcp_rx_arg1==1 || modbus_tcp_rx_arg1==3) lc640_write_int(4354,modbus_tcp_rx_arg1);
	     		}
			if(modbus_tcp_rx_arg0==192)		
				{
				if(modbus_tcp_rx_arg1>=10 && modbus_tcp_rx_arg1<=100) lc640_write_int(0x10+100+110,modbus_tcp_rx_arg1);
	     		}
			if(modbus_tcp_rx_arg0==193)		
				{
				if(modbus_tcp_rx_arg1>=10 && modbus_tcp_rx_arg1<=100) lc640_write_int(0x10+100+112,modbus_tcp_rx_arg1);
	     		}
			if(modbus_tcp_rx_arg0==194)		
				{
				if(modbus_tcp_rx_arg1<=2) lc640_write_int(0x10+100+114,modbus_tcp_rx_arg1);
	     		}
			if(modbus_tcp_rx_arg0==195)		
				{
				if(modbus_tcp_rx_arg1<=2) lc640_write_int(0x10+100+116,modbus_tcp_rx_arg1);
	     		}
			if(modbus_tcp_rx_arg0==196)		
				{
				if(modbus_tcp_rx_arg1>=100 && modbus_tcp_rx_arg1<=2500) lc640_write_int(0x10+100+120,modbus_tcp_rx_arg1);
	     		}
			if(modbus_tcp_rx_arg0==197)		
				{
				if(modbus_tcp_rx_arg1>=100 && modbus_tcp_rx_arg1<=2500) lc640_write_int(0x10+100+122,modbus_tcp_rx_arg1);
	     		}
			if(modbus_tcp_rx_arg0==198)		
				{
				if(modbus_tcp_rx_arg1>=10 && modbus_tcp_rx_arg1<=60) lc640_write_int(0x10+100+124,modbus_tcp_rx_arg1);
	     		}		
			...
			if(modbus_tcp_rx_arg0==200)		
				...
				else if(modbus_tcp_rx_arg1==-1 ) command_rki=38; 
