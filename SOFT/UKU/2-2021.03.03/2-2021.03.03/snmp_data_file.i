...
unsigned char enmv_on[8]; 
unsigned char snmp_enmv_number[64]; 
unsigned char snmp_enmv_data[64][8]; 
unsigned char enmv_data_pred[8][8], enmv_data[8][8]; 
...
if(mode==1)
	...
	lc640_write_int(0x10+100+8,snmp_u_0_grad);
	}
}
...
if(mode==1)
	{
	lc640_write_int(4470,snmp_u_max_power);
	}
}
