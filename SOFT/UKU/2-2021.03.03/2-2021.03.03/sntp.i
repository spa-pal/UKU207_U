...
if (soc == socket_udp) 
	...
	if(time_sinc_hndl_req_cnt)
		{
		((LPC_RTC_TypeDef *) ((0x40000000UL) + 0x24000) )->HOUR=hour_in_this_day;
		((LPC_RTC_TypeDef *) ((0x40000000UL) + 0x24000) )->MIN=min_in_this_hour;
		((LPC_RTC_TypeDef *) ((0x40000000UL) + 0x24000) )->SEC=sec_in_this_min;
		((LPC_RTC_TypeDef *) ((0x40000000UL) + 0x24000) )->YEAR=this_year;
		((LPC_RTC_TypeDef *) ((0x40000000UL) + 0x24000) )->MONTH=this_month;
		((LPC_RTC_TypeDef *) ((0x40000000UL) + 0x24000) )->DOM=day_of_month;
		}
	}
