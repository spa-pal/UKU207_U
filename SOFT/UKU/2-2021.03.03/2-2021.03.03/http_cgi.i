			...
			case '0':
				switch (env[2]) {
					case '1':
						...
						break;
			        case '2':
			          	len = sprintf((char *)buf,(const char *)&env[4],pal_cyr_coder("Àâàðèÿ ÁÏÑ ¹1"));
						break;
				}
		  		break;
		}
		        	...
		        	case '1':
		     		...
		     		case '8':
		         		len = sprintf((char *)buf,(const char *)&env[4],FORVARDBPSCHHOUR," ");
		          		break;		     		
					case '9':
		         		len = sprintf((char *)buf,(const char *)&env[4],0,pal_cyr_coder("Íîâîñèáèðñê Íîâîëóãîâîå 123456789012345678901234"));
		          		break;																				   
				}
				break;
        	case '1':
