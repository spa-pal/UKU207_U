...
void def_sgep_ips_set(short num_of_cell)
{
lc640_write_int(0x10+350+26,3);
lc640_write_int(0x10+350+28,9);

lc640_write_int(0x10+350+72,1);
lc640_write_int(0x10+100+36,2);
lc640_write_int(0x10+500+90,1);
lc640_write_int(0x10+500+100,0);
lc640_write_int(0x10+500+88,0);
lc640_write_int(0x10+54,0);
lc640_write_int(0x10+56,0);
lc640_write_int(0x10+500+104,0);

lc640_write_int(0x10+350+92,num_of_cell*6);
lc640_write_int(0x10+350+70,1500);
lc640_write_int(0x10+350+68,1500);
lc640_write_int(0x10+350+66,1480);
lc640_write_int(0x10+350+64,1410);
lc640_write_int(0x10+350+62,1140);
lc640_write_int(0x10+350+60,945);
lc640_write_int(0x10+350+58,550);

lc640_write_int(0x10+350+86,108*num_of_cell);
lc640_write_int(0x10+350+84,108*num_of_cell);
lc640_write_int(0x10+350+82,105*num_of_cell);
lc640_write_int(0x10+350+80,102*num_of_cell);
lc640_write_int(0x10+350+78,99*num_of_cell);
lc640_write_int(0x10+350+76,96*num_of_cell);
lc640_write_int(0x10+350+74,96*num_of_cell);

if(num_of_cell==17)
	{
	lc640_write_int(0x10+100+6,2363);
	lc640_write_int(0x10+100+8,2295);
	lc640_write_int(0x10+100+14,178);
	}
else if(num_of_cell==18)
	{
	lc640_write_int(0x10+100+6,2502);
	lc640_write_int(0x10+100+8,2430);
	lc640_write_int(0x10+100+14,189);
	}
else if(num_of_cell==20)
	{
	lc640_write_int(0x10+100+6,2780);
	lc640_write_int(0x10+100+8,2700);
	lc640_write_int(0x10+100+14,210);
	}
lc640_write_int(0x10+100+20,20);
lc640_write_int(0x10+100+30,150); 
...
if(num_of_cell==17)
	{
	lc640_write_int(0x10+100+240,250);
	lc640_write_int(0x10+100+106,2448);
	}
else if(num_of_cell==18)
	{
	lc640_write_int(0x10+100+240,250);
	lc640_write_int(0x10+100+106,2560);
	}
else if(num_of_cell==20)
	{
	lc640_write_int(0x10+100+240,278);
	lc640_write_int(0x10+100+106,2880);
	}
lc640_write_int(0x10+350+54,150);
lc640_write_int(0x10+100+76,48);

if(num_of_cell==17)
	{
	lc640_write_int(0x10+100+162,250);
	lc640_write_int(0x10+100+164,2295);

	}
else if(num_of_cell==18)
	{
	lc640_write_int(0x10+100+162,250);
	lc640_write_int(0x10+100+164,2430);

	}
else if(num_of_cell==20)
	{
	lc640_write_int(0x10+100+162,210);
	lc640_write_int(0x10+100+164,2700);
	}
lc640_write_int(0x10+100+166,5);
lc640_write_int(0x10+100+170,10);	
lc640_write_int(0x10+100+172,0);
lc640_write_int(0x10+100+168,1);
lc640_write_int(0x10+350+94,100);
...
if(num_of_cell==17)
	{
	lc640_write_int(0x10+100+4,2600);
	lc640_write_int(0x10+100+84,1200);

	}
else if(num_of_cell==18)
	{
	lc640_write_int(0x10+100+4,2700);
	lc640_write_int(0x10+100+84,1330);

	}
else if(num_of_cell==20)
	{
	lc640_write_int(0x10+100+4,3000);
	lc640_write_int(0x10+100+84,1580);
	}
...
if(num_of_cell==17)
	{
	lc640_write_int(0x10+100+182,2600);
	lc640_write_int(0x10+100+184,1750);
	lc640_write_int(0x10+100+186,100);
	lc640_write_int(0x10+100+224,22011);
	}
else if(num_of_cell==18)
	{
	lc640_write_int(0x10+100+182,2600);
	lc640_write_int(0x10+100+184,1870);
	lc640_write_int(0x10+100+186,100);
	lc640_write_int(0x10+100+224,22011);
	}
else if(num_of_cell==20)
	{
	lc640_write_int(0x10+100+182,2900);
	lc640_write_int(0x10+100+184,1870);
	lc640_write_int(0x10+100+186,100);
	lc640_write_int(0x10+100+224,22011);
	}
lc640_write_int(0x10+100+126,1);
lc640_write_int(0x10+100+178,24);
lc640_write_int(0x10+100+188,1);
lc640_write_int(0x10+100+190,0);
lc640_write_int(0x10+350+2,6000);
lc640_write_int(0x10+350+6,0);
lc640_write_int(0x10+350+20,50);
lc640_write_int(0x10+350+22,3);
lc640_write_int(0x10+350+24,1);
}
