...
if(a_ind . i==iMn_3U)
    ...
    ptrs[6+NUMIST +(num_rki!=0)+(num_net_in!=0)]= 				" Внешние датчики    ";
	ptrs[6+NUMIST +(num_rki!=0)+(num_net_in!=0)+(NUMEXT!=0)]= 	" Ускоренный заряд   ";
	if((speedChIsOn)&&(bFL))ptrs[6+NUMIST +(NUMEXT!=0)]= 	"                     "; 
 	ptrs[7+NUMIST +(num_rki!=0)+(num_net_in!=0)+(NUMEXT!=0)]= 	" Спецфункции    	 ";
    ptrs[8+NUMIST +(num_rki!=0)+(num_net_in!=0)+(NUMEXT!=0)]= 	" Установки          "; 
    ptrs[9+NUMIST +(num_rki!=0)+(num_net_in!=0)+(NUMEXT!=0)]= 	" Журнал событий     "; 
    ptrs[10+NUMIST +(num_rki!=0)+(num_net_in!=0)+(NUMEXT!=0)]= 	" Выход              "; 
    
    
	ptrs[11+NUMIST +(num_rki!=0)+(num_net_in!=0)+(NUMEXT!=0)]=	" Тест               ";
	ptrs[12+NUMIST +(num_rki!=0)+(num_net_in!=0)+(NUMEXT!=0)]=	" Таблица источников ";
...
#line 7409 "main.c"
	...
	ptrs[50]=		"    &               ";
    ptrs[51]=		" РКИ                "; 
	ptrs[51+(num_rki!=0)]=						" Сетевые вводы      "; 
	ptrs[51+(num_rki!=0)+(num_net_in!=0)]=		" Выход              ";	
    ptrs[52+(num_rki!=0)+(num_net_in!=0)]=		" Калибровки         "; 
