...
switch (evt) 
	...
	if(modbus_tcp_unit==MODBUS_ADRESS)
		...
		if(modbus_tcp_func==3)		//чтение произвольного кол-ва регистров хранения
			...
			modbus_hold_registers_transmit(1/*MODBUS_ADRESS*/,modbus_tcp_func,modbus_tcp_rx_arg0,modbus_tcp_rx_arg1,MODBUS_TCP_PROT);
		...
		if(modbus_tcp_func==4)		//чтение произвольного кол-ва регистров	входов
			{
			modbus_input_registers_transmit(1/*MODBUS_ADRESS*/,modbus_tcp_func,modbus_tcp_rx_arg0,modbus_tcp_rx_arg1,MODBUS_TCP_PROT);
			}
	...
	/*				if(modbus_tcp_rx_arg1==1)
				...
				modbus_hold_register_transmit(MODBUS_ADRESS,modbus_tcp_func,modbus_tcp_rx_arg0);
				}
