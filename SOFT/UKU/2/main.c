...
/*	else if(sub_ind==6)
	...
	ptrs[10]=						" БПС N1             ";
     ...
     ptrs[12]=						" БПС N3             ";
	ptrs[13]=						" БПС N4             ";
 	ptrs[10+NUMIST]=				" Сброс              ";
	ptrs[11+NUMIST]=				" Сброс пл.расш.    {";
	ptrs[12+NUMIST]=				" Выход              ";
	ptrs[13+NUMIST]=				"                    ";
	ptrs[14+NUMIST]=				"                    ";
...
/*	else if(sub_ind==5)
	...
	else if((sub_ind>=10)&&(sub_ind<(10+NUMIST))&&(NUMIST)&&((but==butE)))	
		{
		tree_up(iTst_bps,0,0,sub_ind-10);
		can2_out(sub_ind1,sub_ind1,CMND,ALRM_RES,0,0,0,0);
		tst_state[5]=tst1;
		tst_state[6]=tstOFF;
		}											
