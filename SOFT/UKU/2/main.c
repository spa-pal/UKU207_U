...
//oleg_start+
else if( num_net_in && cnt_net_drv==-2) // запрос для сетевого ввода
	{
     if(!bCAN_OFF)
		{
...
else if( num_rki && cnt_net_drv==-1) // запрос для РКИ
	{
     if(!bCAN_OFF)
		{
...
//    ptrs[5+NUMIST/*+NUMBAT+NUMINV*/]= 				" Нагрузка           "; 
	...
	ptrs[6+NUMIST/*+NUMBAT+NUMINV*/+(num_rki!=0)+(num_net_in!=0)+(NUMEXT!=0)]= 	" Ускоренный заряд   ";
	if((speedChIsOn)&&(bFL))ptrs[6+NUMIST/*+NUMBAT+NUMINV*/+(NUMEXT!=0)]= 	"                     "; 
 	ptrs[7+NUMIST/*+NUMBAT+NUMINV*/+(num_rki!=0)+(num_net_in!=0)+(NUMEXT!=0)]= 	" Спецфункции    	 ";
    ptrs[8+NUMIST/*+NUMBAT+NUMINV*/+(num_rki!=0)+(num_net_in!=0)+(NUMEXT!=0)]= 	" Установки          "; 
    ptrs[9+NUMIST/*+NUMBAT+NUMINV*/+(num_rki!=0)+(num_net_in!=0)+(NUMEXT!=0)]= 	" Журнал событий     "; 
    ptrs[10+NUMIST/*+NUMBAT+NUMINV*/+(num_rki!=0)+(num_net_in!=0)+(NUMEXT!=0)]= 	" Выход              "; 
    //ptrs[11+NUMIST/*+NUMBAT+NUMINV*/+(NUMEXT!=0)]= 	" Журнал батареи     "; 
    //ptrs[12+NUMIST+NUMBAT+/*NUMINV+*/(NUMEXT!=0)]= 	" Журнал батареи N2  "; 
	ptrs[11+NUMIST/*+NUMBAT+NUMINV*/+(num_rki!=0)+(num_net_in!=0)+(NUMEXT!=0)]=	" Тест               ";
	ptrs[12+NUMIST/*+NUMBAT+NUMINV*/+(num_rki!=0)+(num_net_in!=0)+(NUMEXT!=0)]=	" Таблица источников ";
