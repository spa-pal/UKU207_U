 ...
 if((modbus_rx_arg1>0)&&(modbus_rx_arg1<=5))modbus_rx_arg1=0;
		...
		if(modbus_func==4)		
			...
			if(modbus_an_buffer[2]==2)
				...
				ica_pwm=(((unsigned short)modbus_an_buffer[3])*((unsigned short)256))+((unsigned short)modbus_an_buffer[4]);
				plazma1000[3]++;
				modbus_buff[0] = 1;
				modbus_buff[1] = 6;
				modbus_buff[2] = 0;
				modbus_buff[3] = 100;
				modbus_buff[4] = (char)(ica_pwm/256);	
				modbus_buff[5] = (char)(ica_pwm%256);
		...
		if(modbus_func==4)		
			...
			if(modbus_an_buffer[2]==2)
				...
				ica_current=(((unsigned short)modbus_an_buffer[3])*((unsigned short)256))+((unsigned short)modbus_an_buffer[4]);
				plazma1000[1]++;
				modbus_buff[0] = 2;
				modbus_buff[1] = 6;
				modbus_buff[2] = 0;
				modbus_buff[3] = 101;
				modbus_buff[4] = (char)(ica_current/256);	
				modbus_buff[5] = (char)(ica_current%256);
