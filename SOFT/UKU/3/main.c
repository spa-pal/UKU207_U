...
signed short ica_pwm;
signed short ica_current;
U8 tcp_soc_avg;
U8 tcp_connect_stat;
...
short modbus_req_adr;
short modbus_req_reg;
short modbus_req_num;
short master_timer_cnt;
//-----------------------------------------------
void rtc_init (void) 
{
LPC_RTC->CCR=0x11;
...
//	if((AUSW_MAIN==22063)||(AUSW_MAIN==22023)||(AUSW_MAIN==22043))
	...
	/*int2lcdyx(master_timer_cnt,0,2,0);
	int2lcdyx(modbus_req_adr,0,6,0);
	int2lcdyx(modbus_req_reg,0,10,0);
	int2lcdyx(ica_pwm,0,19,0);
	int2lcdyx(ica_current,0,15,0); */
//	int2lcdyx(bat[0]._temper_stat,0,16,0);
	...
	int2lcdyx(plazma1000[4],2,3,0);
	int2lcdyx(plazma1000[5],2,8,0);
	int2lcdyx(plazma1000[6],2,13,0);
	int2lcdyx(plazma1000[7],2,18,0);
...
//-----------------------------------------------
void master_hndl (void) 
{
if(++master_timer_cnt>=10)
	{
	master_timer_cnt=0;
		{
