...
{
//const char* ptr;
const char* ptrs[90];		//oleg_stard* было 60
const char* sub_ptrs[250];	//oleg_stard* было 50
...
//		{
    ...
    ptrs[3]=" 0%:0^:0& 0z/w  /0{ ";	  //oleg_stard* заменил < на z, > на w.
	ptrs[4]="     Tб    ?°C      ";
/*     
 	ptrs[4]=										" Батарея N1         ";
    ptrs[5]=										" Батарея N2         ";
...
//	if((AUSW_MAIN==22063)||(AUSW_MAIN==22023)||(AUSW_MAIN==22043))
	...
	int2lcd(LPC_RTC->MIN,'^',0);
	int2lcd(LPC_RTC->SEC,'&',0);
	int2lcd(LPC_RTC->DOM,'z',0);   //oleg_stard* заменил < на z
	int2lcd(LPC_RTC->YEAR,'{',0); 
	sub_bgnd(sm_mont[LPC_RTC->MONTH],'w',0);  //oleg_stard* заменил > на w
...
//	int2lcd(TBATSIGN,'X',0);
 ...
 /*    ptrs[32]=      " Контроль ср.точки  ";
	...
	ptrs[50]=		"    &               ";
    ptrs[51]=		" РКИ                "; // oleg_stard* вставлена строка
	ptrs[51+(num_rki!=0)]=						" Сетевые вводы      "; // oleg_stard* вставлена строка
	ptrs[51+(num_rki!=0)+(num_net_in!=0)]=		" Выход              ";	// oleg_stard* добавил +(num_rki!=0)
    ptrs[52+(num_rki!=0)+(num_net_in!=0)]=		" Калибровки         "; // oleg_stard* добавил +(num_rki!=0)
    ptrs[53+(num_rki!=0)+(num_net_in!=0)]=		"                    "; // oleg_stard* добавил +(num_rki!=0)       
...
}// end if(uku_or_rki==0){	//oleg_stard*
//oleg_stard*
else if(uku_or_rki==1){	//oleg_stard*		
		...
		if(sub_ind==0)
			...
			{	
				...
				while(!(avar_ind_stat&(1<<sub_ind)))
					...
					if(sub_ind>=32)
						{
						if(!rki_avar1_ind_stat) tree_down(0,0);	//oleg_stard* добавил if(!rki_avar1_ind_stat)
						avar_ind_stat=0;
						}
					}
			}
...
/*		else if(sub_ind==(2+NUMBAT+NUMIST))
		...
		else if((sub_ind==(3/*+NUMBAT*/+NUMIST/*+NUMINV*/)+(num_rki!=0)+(num_net_in!=0))&&(NUMEXT))	//oleg_stard* добавил +(num_rki!=0)
			{
			tree_up(iExtern_220,0,0,0);
		     ret(1000);
			}

		else if(sub_ind==(3+NUMBAT+NUMIST+/*NUMINV+*/(NUMEXT!=0))+(num_rki!=0)+(num_net_in!=0))	 	//oleg_stard* добавил +(num_rki!=0)
			{
			speedChargeStartStop();
			}

		else if(sub_ind==(4+NUMBAT+NUMIST+/*NUMINV+*/(NUMEXT!=0))+(num_rki!=0)+(num_net_in!=0))	 	//oleg_stard* добавил +(num_rki!=0)
			{
			tree_up(iSpc_termocompensat,0,0,0);
		     ret(1000);
			}

		else if(sub_ind==(5+NUMBAT+NUMIST+/*NUMINV+*/(NUMEXT!=0))+(num_rki!=0)+(num_net_in!=0))	 	//oleg_stard* добавил +(num_rki!=0)
			{
			tree_up(iSet_prl,0,0,0);
		     ret(50);
		     parol_init();
			}
		else if(sub_ind==(6+NUMBAT+NUMIST+/*NUMINV+*/(NUMEXT!=0))+(num_rki!=0)+(num_net_in!=0))		//oleg_stard* добавил +(num_rki!=0)
			{
			if(but==butE_)avar_uout_hndl(1);
			tree_up(iLog,0,0,0);
		     ret(1000);
			}
		else if(sub_ind==(7+NUMBAT+NUMIST+/*NUMINV+*/(NUMEXT!=0))+(num_rki!=0)+(num_net_in!=0))		//oleg_stard* добавил +(num_rki!=0)
			{
			sub_ind=0;
			}
	/*	else if(sub_ind==(8+NUMBAT+NUMIST+NUMINV+(NUMEXT!=0)))
...
/*		else if(sub_ind==(9+NUMBAT+NUMIST+NUMINV+(NUMEXT!=0)))
		...
		else if(sub_ind==(8+NUMBAT+NUMIST+/*NUMINV+*/(NUMEXT!=0))+(num_rki!=0)+(num_net_in!=0))		//oleg_stard* добавил +(num_rki!=0)
			{
			if(but==butE)
		     	{
		     	tree_up(iPrltst,0,0,0);
		...
		else if(sub_ind==(9+NUMBAT+NUMIST+/*NUMINV+*/(NUMEXT!=0))+(num_rki!=0)+(num_net_in!=0))	 	//oleg_stard* добавил +(num_rki!=0)
			{
			if(but==butE)
		     	{
		     	tree_up(iBps_list,0,0,0);
...
/*	else if(sub_ind==32)
	...
	if(but==butD)
        ...
        if(sub_ind==48)
        	{
            sub_ind=49;
			index_set=49; // oleg_stard*
		    }
        if(sub_ind==50)
        	{
            sub_ind=51;
		    }																	
		gran_char(&sub_ind,0,52+(num_rki!=0)+(num_net_in!=0)); //oleg_stard* было	 gran_char(&sub_ind,0,52);
       ...
       /* if(sub_ind==39)
		...
		{
		sub_ind=51+(num_rki!=0)+(num_net_in!=0); // oleg_stard* было 51
	...
	// oleg_end	
	else if(sub_ind==52)// oleg_stard* было 51
		{
		if(but==butE)
		     {
	...
	else if(sub_ind==53) // oleg_stard* было 52
		{
		if(but==butE)
		    {	
...
/**/    else if(sub_ind==5)	  /**/
	...
	if(but==butD)
		{
		sub_ind++;
		gran_char(&sub_ind,0,6); // oleg_stard* было 4
		}
	else if(but==butU)
		{
		sub_ind--;
 ...
 // oleg_end		  			  			                 
    else if(sub_ind==6)	 // oleg_stard было 4
	     {
	     if(but==butE)
	          {
			tree_down(0,0);
...
/**/	   	else if(sub_ind==(2+(NUMBAT!=0)+(NUMIST!=0)+(NUMINV!=0)+2))	   /**/
	...
	if(but==butD)
		{
		sub_ind++;
		gran_char(&sub_ind,0,3+(NUMIST!=0)+(NUMDT!=0)+(num_rki!=0)+(num_net_in!=0)); //oleg_stard+
		}
	else if(but==butU)
		{
		sub_ind--;
		...
		//oleg_end				
        else if(sub_ind==(3+(NUMIST!=0)+(NUMDT!=0)+(num_rki!=0)+(num_net_in!=0))) // oleg_stard+ добавил +(num_rki!=0)+(num_net_in!=0)
			{
	          tree_down(0,0);
	          ret(0);
            }	               			
	...
	if(but==butE)
		...
		if(uku_or_rki==0){	//oleg_stard*
			...
			if(avar_ind_stat)
			{
				...
				if(sub_ind>=32)
					{
					if(rki_avar1_ind_stat==0) tree_down(0,0); //oleg_stard*		tree_down(0,0);
					else {sub_ind=-1; uku_or_rki=1;}	//oleg_stard*
					avar_ind_stat=0;
					}
				}
		 	}
			...
			{
				if(rki_avar1_ind_stat==0) {tree_down(0,0);} //oleg_stard*		tree_down(0,0);
				else {uku_or_rki=1;	sub_ind=-1;}//oleg_stard*
				avar_ind_stat=0;
