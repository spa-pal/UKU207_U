...
#line 239 "eeprom_map.h"



#line 295 "eeprom_map.h"
...
else if( num_net_in && cnt_net_drv==18) 
	{
     if(!bCAN_OFF)
		{
...
else if( num_rki && cnt_net_drv==19) 
	{
     if(!bCAN_OFF)
		{
...
if(a_ind . i==iMn_3U)
	...
	ptrs[6+NUMIST +(NUMEXT!=0)+(num_rki!=0)+(num_net_in!=0)]= 	" Ускоренный заряд   ";
	if((speedChIsOn)&&(bFL))ptrs[6+NUMIST +(NUMEXT!=0)+(num_rki!=0)+(num_net_in!=0)]= 	"                     "; 
 	ptrs[7+NUMIST +(NUMEXT!=0)+(num_rki!=0)+(num_net_in!=0)]= 	" Спецфункции    	 ";
    ptrs[8+NUMIST +(NUMEXT!=0)+(num_rki!=0)+(num_net_in!=0)]= 	" Установки          "; 
    ptrs[9+NUMIST +(NUMEXT!=0)+(num_rki!=0)+(num_net_in!=0)]= 	" Журнал событий     "; 
    ptrs[10+NUMIST +(NUMEXT!=0)+(num_rki!=0)+(num_net_in!=0)]= " Выход              "; 
    
    
	ptrs[11+NUMIST +(NUMEXT!=0)+(num_rki!=0)+(num_net_in!=0)]=	" Тест               ";
	ptrs[12+NUMIST +(NUMEXT!=0)+(num_rki!=0)+(num_net_in!=0)]=	" Таблица источников ";
